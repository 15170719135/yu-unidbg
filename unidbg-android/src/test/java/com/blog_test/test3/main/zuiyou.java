package com.blog_test.test3.main;
...
//        System.out.println(test.callSign());
    ...
    zuiyou() {
        ...
        vm = emulator.createDalvikVM(new File("C:\\D\\YiDong_Pan\\apk\\right573.apk")); // 创建Android虚拟机
        DalvikModule dm = vm.loadLibrary(new File("unidbg-android/src/test/java/com/blog_test/test3/main/libnet_crypto.so"), true); // 加载so到虚拟内存 , false 的话会乱码
