...
public class blackbox extends AbstractJni {
    ...
    blackbox() throws FileNotFoundException {
        ...
        // 填入自己的path
        /*String traceFile = "unidbg-android/src/test/java/com/blog_test/test9/traceCode2.txt";
        PrintStream traceStream = new PrintStream(new FileOutputStream(traceFile), true);
        emulator.traceCode(module.base, module.base+module.size).setRedirect(traceStream); //日志重定向*/
...
//        Logger.getLogger("com.github.unidbg.unix.UnixSyscallHandler").setLevel(Level.DEBUG);
        ...
        test.hook37a0();
        System.out.println(test.callEncode()); // 分析的目标 (native) com.max.xiaoheihe.utils.NDKTools.encode(arg1, arg2, arg3)
...
//        }
    ...
    public String callEncode(){
        ...
        Number number = module.callFunction(emulator, 0x3b41, list.toArray());//com.max.xiaoheihe.utils.NDKTools.encode(arg1, arg2, arg3)
