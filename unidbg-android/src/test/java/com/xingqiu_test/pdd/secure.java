...
//        demo.nativeGenerate();
        System.out.print("call nativeGenerate2");
    ...
    secure()  {
        ...
        vm = emulator.createDalvikVM(new File("C:\\D\\YiDong_Pan\\unidbg\\PDD nativeGenerate2 的模拟执行\\files\\PDD_8\\拼多多官方.apk")); // 创建Android虚拟机
        ...
        DalvikModule dm_libUserEnv = vm.loadLibrary(new File("C:\\D\\YiDong_Pan\\unidbg\\PDD nativeGenerate2 的模拟执行\\files\\PDD_8\\libUserEnv.so"),true);
        dm_libUserEnv.callJNI_OnLoad(emulator);
        DalvikModule dm = vm.loadLibrary(new File("C:\\D\\YiDong_Pan\\unidbg\\PDD nativeGenerate2 的模拟执行\\files\\PDD_8\\libpdd_secure.so"), true);
